...
export type DashboardState = {
  ...
  quickCompare: Array<{ provider: string; hourly: string; monthly: string; latency: string }>;
...
const formState: DashboardState = {
  summary: [
    ...
    { id: "alerts", title: "Performance Alerts", value: "3 Active", subtitle: "2 CPU, 1 Memory hotspots" },
  ...
  quickCompare: [
    { provider: "AWS", hourly: "$0.080", monthly: "$58.40", latency: "15ms" },
    { provider: "Azure", hourly: "$0.085", monthly: "$62.05", latency: "20ms" },
    { provider: "Google Cloud", hourly: "$0.078", monthly: "$56.94", latency: "18ms" },
    { provider: "IBM Cloud", hourly: "$0.090", monthly: "$65.70", latency: "30ms" },
    { provider: "Oracle Cloud", hourly: "$0.070", monthly: "$51.10", latency: "25ms" },
  ],
  recentArchitectures: [
